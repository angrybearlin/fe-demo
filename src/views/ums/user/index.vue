<template>
    <div>
        <div class="lkx-filter">
            <el-input v-model="searchVal" placeholder="输入用户名搜索"></el-input>
        ...
        <el-table :data="tableData.records">
                ...
                <template slot-scope="scope">
                    <el-popover
                        ...
                        <el-avatar
                            shape="square"
                            :size="100"
                            :src="imgpath(scope.row.icon)"></el-avatar>
                        <span slot="reference">{{scope.row.name}}</span>
                    </el-popover>
                </template>
            </el-table-column>
            <el-table-column show-overflow-tooltip label="手机号" prop="phone"></el-table-column>
            <el-table-column show-overflow-tooltip label="电子信箱" prop="email"></el-table-column>
            ...
            <el-table-column width="150px">
                <template slot="header">
                    <el-button type="primary" plain size="small" @click="add()">添加用户</el-button>
                </template>
                <template slot-scope="scope">
